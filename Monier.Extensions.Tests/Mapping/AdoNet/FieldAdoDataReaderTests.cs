...
using Monier.Extensions.Mapping.AdoNet;
using Monier.Mapping;
using System;
...
{
    [TestClass]
    public class FieldAdoDataReaderTests
    {
        ...
        public void MapUsingFieldPrefix()
        {
            ...
            dt.Rows.Add(row);
            dataReader = dt.CreateDataReader();
            var entities = FieldMapper.Map<MyEntity02>(new FieldAdoDataReader(dataReader)).ToList();
